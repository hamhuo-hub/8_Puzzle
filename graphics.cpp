...
LPWSTR font_name[] =
{
    L"Console",          // DefaultFont
    L"Times New Roman",  // TriplexFont
    L"Small Fonts",      // SmallFont
    L"MS Sans Serif",    // SansSerifFont
    L"Arial",            // GothicFont
    L"Script",           // ScriptFont
    L"Times New Roman",  // SimplexFont
    L"Script",           // TriplexScriptFont
    L"Courier New",      // ComplexFont
    L"Times New Roman",  // EuropeanFont
    L"Courier New Bold", // BoldFont
};
*/
...
class font_cache : public l2list { 
  ...
  public: 
	...
	hFont = CreateFont(-height,
			   ...
			   DEFAULT_QUALITY,
			   font_family[type], 
               font_name[type]); //original        
			   //LPCWSTR(font_name[type])); //test only
